...
import YouTube from '@/components/ArticleRelated/embeds/YouTube.svelte'
...
![](https://cdn.jsdelivr.net/gh/ChungYingHo/Jeremy-Assets@0e84348c8fe958f73c61c98d2bc775533792cccf/Jeremy-and-Aira/src/content/techbook/languages/javascript/01KVFDJG4X2CAYV4903WJ9688W.png)
...
![](https://cdn.jsdelivr.net/gh/ChungYingHo/Jeremy-Assets@324507aadcdf7e65186689c9fad0dab77a912f3a/Jeremy-and-Aira/src/content/techbook/languages/javascript/01KVFDKNND6DB2Y4Q07ED2BCEJ.png)
...
然後最後一般會用 `finally` 來處理不論成功或失敗都會執行的邏輯。 因此，Promise 的使用方式通常會長得像這樣的鏈式邏輯：`A().then(B).catch(handleError).finally(cleanup)`。
