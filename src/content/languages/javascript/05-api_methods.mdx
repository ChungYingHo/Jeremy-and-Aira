...
1. [Day15 - Waiter! 然後 API 端上了一盤 response](https://jeremyho.tw/docs/series/iThome_2025/day_15)
    - API 的作用
    - 各式各樣的 API (SOAP、RESTful、GraphQL)
2. [Day16 - 404 Not Found!](https://jeremyho.tw/docs/series/iThome_2025/day_16)
    - 常見的 HTTP 狀態碼介紹
:::
