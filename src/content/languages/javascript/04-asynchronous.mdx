...
- 2026/01/27：Update the info about call stack and callback queue.
:::

:::info
關於非同步的概論，可以參考我在 2025 iThome 寫的[文章](https://jeremyho.tw/docs/series/iThome_2025/day_14)。  
...
![Call stack](./img/04_call_stack.png)
...
## async/await
基於我在 iThome 2025 [文章](https://jeremyho.tw/docs/series/iThome_2025/day_14#asyncawait)裡對 async/await 做了很詳細的說明，這裡只節錄重點。  
