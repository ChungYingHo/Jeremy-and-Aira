...
import StackVisualizer from '@/components/ArticleRelated/data-structure/stack-queue/StackVisualizer.svelte'
import QueueVisualizer from '@/components/ArticleRelated/data-structure/stack-queue/QueueVisualizer.svelte'
...
<StackVisualizer client:only="svelte" />
...
<QueueVisualizer client:only="svelte" />
