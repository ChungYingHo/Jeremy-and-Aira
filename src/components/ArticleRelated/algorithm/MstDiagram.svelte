...
<div class="w-full max-w-3xl mx-auto my-8 bg-cream rounded-xl border border-line shadow-sm overflow-hidden">
  <svg viewBox="0 0 420 250" class="w-full px-2 pt-2 pb-1" font-family="sans-serif">
    ...
    <!-- title -->
    <text x="210" y="18" fill="#8f8a80" font-size="10" text-anchor="middle">加權無向圖與最小生成樹（MST 邊以綠色標示，總權重 16）</text>
    ...
    {#each Object.values(nodes) as n}
      ...
      <text x={n.x} y={n.y} fill="#2d2a25" font-size="11" font-weight="bold" text-anchor="middle" dominant-baseline="middle">{n.label}</text>
    {/each}

    <!-- legend -->
    <line x1="24" y1="236" x2="44" y2="236" stroke="#5f7355" stroke-width="2.5" />
    <text x="48" y="240" fill="#5d574d" font-size="9">MST 邊</text>
    <line x1="96" y1="236" x2="116" y2="236" stroke="#d6d1c5" stroke-width="1.5" stroke-dasharray="5,3" />
    <text x="120" y="240" fill="#5d574d" font-size="9">非 MST 邊</text>
  </svg>
</div>
